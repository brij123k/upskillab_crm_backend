...
export class ProfileLogic {
 ...
 private normalizeProfilePayload(data: any) {
  ...
  if (data.departmentId)
    payload.departmentId = new Types.ObjectId(data.departmentId);

  if (data.reportingSeniorId)
    payload.reportingSeniorId = new Types.ObjectId(data.reportingSeniorId);
  ...
  if (data.bankDetails !== undefined)
    payload.bankDetails = data.bankDetails;

  if (data.educationalDetails !== undefined)
    payload.educationalDetails = data.educationalDetails;
